...
const Header = () => {
  return (
    <div>
      <nav className="flex justify-items-center md:h-[80px] md:flex md:w-full md:justify-end md:items-center text-black font-railway font-semibold shadow-lg pr-10 text-2xl bg-gray-100 static">
